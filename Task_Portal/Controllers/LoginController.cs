...
namespace Task_Portal.Controllers
{
    public class LoginController : Controller
    {
        ...
        public IActionResult Login()
        {
            ...
            if (activeUser == null)
                return _view;
            var LogOutDate = activeUser.LoginDate == null ? DateTime.Now.AddMinutes(10) : activeUser.LoginDate.AddMinutes(10);
            if (activeUser != null && activeUser.LoginDate < LogOutDate)
            {
